    ...
    <section class="space-y-6">
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="rounded-lg border border-red-500/50 bg-slate-900 p-6">
                <h2 class="text-lg font-bold text-white">Are you sure you want to delete your account?</h2>

                <p class="mt-1 text-sm text-slate-300">
                    Once your account is deleted, all of its data will be permanently destroyed.
